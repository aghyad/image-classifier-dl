...
def load_image(image_path):
    ...
    :return: PIL image (example: PIL.JpegImagePlugin.JpegImageFile)
    """
...
def process_image(pil_image):
    ...
    :return: ndarray; the image with shape (3, 224, 224)
    """
    # Resize the image
    ...
    # transpose the image ndarray to make color channel first,
    # preserving the order of the other two channels
...
def predict(image_path, model, classes_to_names, topk=5, device='cpu'):
    ...
    :return:
        top_probs: top probablities of category
        top_idxs: indexes of categories
    """
...
if __name__ == "__main__":
    ...
    $ python predict.py path/to/some_image.jpg model_checkpoint
    ...
    Returns the flower name and class probability (topK ordered)
    """
